<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
    ...
    <g fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M9 19" stroke-dasharray="10" stroke-dashoffset="10">
    ...
    <rect mask="url(#eyes)" x="8" y="11" width="8" height="4" fill="currentColor">
        <animate attributeName="y" values="11;11;7;7;11;11" keyTimes="0;0.45;0.46;0.54;0.55;1" dur="10s" repeatCount="indefinite" />
    </rect>
</svg>